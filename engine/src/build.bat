...
PUSHD ..\build
cl %compilerFlags% ..\editor\*.cpp ..\components\*.cpp ..\renderer\*.cpp ..\util\*.cpp ..\src\*.cpp ..\src\*.c ..\..\libs\tinyxml\*.cpp ..\..\libs\imgui\backends\imgui_impl_glfw.cpp ..\..\libs\imgui\backends\imgui_impl_opengl3.cpp ..\..\libs\imgui\imgui*.cpp -FeArcaneEngine /I%includeTINYXMLPath% /I%includeIMGUIPath% /I%includeGLMPath% /I%includeGLFWPath% /I%includeGLADPath% /link /LIBPATH:%linkerGLFWPath% /SUBSYSTEM:CONSOLE %linkerFlags%
POPD
